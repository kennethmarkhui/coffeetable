import { FaInstagram, FaFacebook, FaStore, FaCcVisa, FaCcMastercard, FaCcPaypal } from 'react-icons/fa';
...
const Footer = () => {
  return <footer className="bg-black text-slate-300">
    ...
    <div className="flex justify-between">
      <div className="flex flex-col">{/* left col  */}
        ...
        <div className="text-yellow0">
          {phone_number.map((number) => number.number1)}
        </div>
        <div className="text-yellow0">
          {phone_number.map((number) => number.number1)}
        </div>
        ...
        <div className="flex">
          <FaCcVisa size={"3em"}/> <FaCcMastercard size={"3em"}/> <FaCcPaypal size={"3em"}/> <SiAmericanexpress size={"3em"}/> 
        </div>
      </div>
      ...
      <div className="flex flex-col gap-1"> {/* right col  */}
        <div>
          BUSINESS HOURS
        </div>
        <div>
    ...
    <div className="text-center">
      ...
      <span className="text-yellow0"> Terms of Use</span> | <span className="text-yellow0">Privacy Policy</span>
    </div>
    </div>
